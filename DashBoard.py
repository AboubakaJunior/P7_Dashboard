...
st.markdown("<h1 style='text-align: center; color: red; font-size: 100px;'>DEMANDE DE PRÊT BANCAIRE</h1>", unsafe_allow_html=True)

#st.write('''BANCAIRE''')

# st.title () : écriture des titres
st.markdown("<h1 style='text-align: center; color: black; font-size: 40px;'>**♟**Crédit Score du Client **♟**</h1>", unsafe_allow_html=True)
...
st.markdown("<h1 style='text-align: center; color: Black; font-size: 50px;'>CARACTERISQUES DU CLIENT</h1>", unsafe_allow_html=True)
...
st.markdown("<h1 style='text-align: center; color: Black; font-size: 50px;'>INDICATEURS INFLUENCANTS LE TAUX DE RISQUE</h1>", unsafe_allow_html=True)
...
exp = Explainer.explain_instance(DataBaseTest.values[W], model_Forest.predict_proba, num_features = 20)

#exp = Explainer.explain_instance(data_row=Y.reshape(1, Y.shape[1])[0], predict_fn=model_Forest.predict_proba)
components.html(exp.as_html(), height=800)
exp.as_list()

st.markdown("<h1 style='text-align: center; color: Black; font-size: 50px;'>ANALYSE GLOBALE ET POSITIONNEMENT DU CLIENT</h1>", unsafe_allow_html=True)

st.markdown("<h1 style='text-align: left; color: black; font-size: 30px;'>Age (ans) </h1>", unsafe_allow_html=True)
...
st.markdown("<h1 style='text-align: left; color: black; font-size: 30px;'> Ancienneté (ans) </h1>", unsafe_allow_html=True)
...
st.markdown("<h1 style='text-align: left; color: black; font-size: 30px;'>Ext_Source_2 </h1>", unsafe_allow_html=True)
...
st.markdown("<h1 style='text-align: left; color: black; font-size: 30px;'>Ext_Source_3 </h1>", unsafe_allow_html=True)
...
st.markdown("<h1 style='text-align: left; color: black; font-size: 30px;'> Revenu Total ($) </h1>", unsafe_allow_html=True)
